...
const SideBar = () => {
  ...
  return <>
    <aside className={`${isNavbarOpened ? "left-[10px]" : "-left-full"} fixed w-64 h-[97.5%] rounded-2xl bg-white z-10 mt-[10px] transition-all duration-300 shadow-lg p-4 space-y-4 flex flex-col justify-between md:left-[10px]`}>
      ...
      <button onClick={handleLogout} className="text-white flex items-center rounded-md cursor-pointer px-3 py-2 gap-2 bg-red-gradient">
        <LogOut />Logout
      </button>
    </aside>
  </>;
