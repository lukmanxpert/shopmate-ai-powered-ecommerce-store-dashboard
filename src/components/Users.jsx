                      ...
                      return (
                        <tr key={index} className="border-t hover:bg-gray-50">
                          ...
                          <td className="px-3 py-4">
                            <button onClick={() => handleDeleteUser(user.id)} className="text-white rounded-md cursor-pointer px-3 py-2 font-semibold bg-red-gradient hover:opacity-90 transition-all">Delete</button>
                          </td>
                        </tr>
                      )
                    })
