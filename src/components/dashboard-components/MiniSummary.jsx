...
const MiniSummary = () => {
  ...
  const summary = [
    {
      ...
      subText: `This month's sales: BDT ${currentMonthSales * 125}`,
      icon: <Wallet className="text-green-600" />
    },
    {
      text: "Total Order Placed",
      subText: `Total order placed: ${totalOrders}`,
  ...
  return <>
    <div className="bg-white rounded-xl p-6 shadow-md">
      <h2 className="text-lg font-semibold mb-2">Summery</h2>
      <p className="text-sm text-gray-500 mb-4">Summery of key metrics for the current month</p>
