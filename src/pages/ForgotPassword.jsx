      ...
      <div className="bg-white shadow-lg rounded-2xl max-w-md w-full p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="p-2">
            ...
            <input type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="example@example.com" className="w-full px-4 py-3 border border-gray-300 rounded-md" />
          </div>
