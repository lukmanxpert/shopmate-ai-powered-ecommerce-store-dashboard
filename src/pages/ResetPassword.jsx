      ...
      <div className="bg-white shadow-lg rounded-2xl max-w-md w-full p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="p-2">
            ...
            <input type="password" name="password" value={formData.password} onChange={handleChange} required placeholder="Enter new password" className="w-full px-4 py-3 border border-gray-300 rounded-md" />
          </div>
          ...
          <div className="p-2">
            ...
            <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} required placeholder="Enter confirm password" className="w-full px-4 py-3 border border-gray-300 rounded-xl" />
          </div>
